...
p1 <- ggplot(data=term.life.pos) + geom_histogram(aes(x=FACE,y=..density..)) + scale_x_log10()
p2 <- ggplot(data=term.life.pos) + geom_histogram(aes(x=Ratio,y=..density..))+ scale_x_log10()
...
p1 <- ggplot(data=term.life) + geom_histogram(aes(x=age.diff,y=..density..))
p1
...
p2 <- ggplot(data=term.life.nonzeroSAGE) + geom_histogram(aes(x=abs.diff,y=..density..))
p2
```
...
ggplot(data=term.life, aes(x=EDUCATION,y=SEDUCATION)) + geom_point()
```
...
ggplot(data=term.life.poseduc, aes(x=educ.diff)) + geom_bar()
```
