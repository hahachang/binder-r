---
title: "Predictive Analtyics Exam Module 6 Section 3"
...
CHUNK 7 provides an example of combining multiple variables into a single factor.
...
binarizer <- dummyVars(paste("~", paste(vars.bin, collapse = "+")), 
                              data = data.mortality, fullRank = F)
